...
export default function ChatBox({ friend, initialMessages = [], onMarkedAsRead }) {
  ...
  return (
    <div
      ...
      style={{ height: 'calc(100vh - 90px)', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", overflow: 'hidden' }}
    >
      {/* Header */}
      <div
          ...
          <div key={i} className={`flex ${msg.fromMe ? "justify-end" : "justify-start"}`}>
            {msg.image_url ? (
              ...
              <div className={`max-w-[60%] px-6 py-4 rounded-2xl whitespace-pre-wrap break-words shadow-md ${msg.fromMe ? "bg-blue-600 text-white" : "bg-white text-gray-900"}`}>
                {msg.file_url ? (
                  <a href={msg.file_url} target="_blank" rel="noopener noreferrer" className="text-white underline">
